...
(function () {
  ...
  /* REDUCED MOTION (22 Sep 2026) — the clip no longer freezes on a poster. It is a
     DEMONSTRATION, not decoration: the story still plays, with the movement taken out.
     The bubbles appear instead of sliding up (the @media block in CSS), the roll jumps
     instead of scrolling, and the question is set at once instead of typed. */
